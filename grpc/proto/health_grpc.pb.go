...
func (c *healthCheckClient) Ping(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (UnimplementedHealthCheckServer) Ping(context.Context, *HealthRequest) (*HealthResponse, error) {
...
func _HealthCheck_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthCheckServer).Ping(ctx, req.(*HealthRequest))
	}
